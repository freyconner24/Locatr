var Locatn = React.createClass({
    render: function() {
        ...
        return (
            <div className='locatnInfo'>
                <div className='row mapPicCont'>
                    <div className='col-sm-7 picCont'>
                        <div className='locatnPic' style={divStyle}>
                            <div id="locatnBackButton" className='backButton' onClick={this.closeLocatn}>back</div>
                            <div className='number'>1</div>
                        </div>
                        <div className='locatnText'>
                            <div className='locatnTitle'>{title} &nbsp;<span className='editText' onClick={this.editLocatn}>edit</span></div>
                            <div className='locatnDesc'>{description}</div>
                        </div>
                    </div>
                    <div className='col-sm-5 mapCont'>
                        <div className='map' id='mapCanvas'></div>

var Locatn = React.createClass({displayName: "Locatn",
    render: function() {
        ...
        google.maps.event.addDomListener(window, 'load', function() {this.initializeMap(latitude, longitude)}); // Execute our 'initialize' function once the page has loaded. 

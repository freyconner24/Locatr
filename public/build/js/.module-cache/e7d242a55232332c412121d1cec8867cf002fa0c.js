    ...
    showLocatn: function(locatnId) {
        ...
        query.get(locatnId.objectId, {
            success: function(locatn) {
                ...
                var MyOtherComponent = React.createClass({displayName: "MyOtherComponent",
                  render: function() {
                    return React.createElement(Locatn, {locatn: locatn});
                  }
                });

                var reactElement = React.createElement(MyOtherComponent);
                reactElement.setProps(locatn);

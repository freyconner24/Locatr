        ...
        return (
            React.createElement("div", {className: "row locatnsRow"}, 
                this.props.locatnThree.map(function(locatnAndNum) {
                	return React.createElement("div", {onClick: this.showLocatnFromProject.bind(this, locatn.id), key: locatn.id}, React.createElement(ProjectLocatn, {locatnAndNum: locatnAndNum, key: locatnAndNum.locatn.id}))
                })
            )
        );
    },

var Locatn = React.createClass({displayName: "Locatn",
    render: function() {
        ...
        if (this.data.locatn !== undefined) {
            title = this.data.locatn.title;
            description = this.data.locatn.description;
            imageFile = this.data.locatn.picture;
            imageURL = imageFile.url();
            divStyle.backgroundImage = 'url(' + imageURL + ')';
            profileTag = (React.createElement(ProfileTag, {locatn: this.data.locatn}));
        }

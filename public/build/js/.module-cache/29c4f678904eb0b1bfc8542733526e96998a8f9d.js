var Locatn = React.createClass({displayName: "Locatn",
    render: function() {
        ...
        if (this.props.locatn !== undefined) {
            ...
            longitude = this.props.locatn;
            latitude = this.props.locatn;
            googleMapsURL = "https://www.google.com/maps/embed/v1/view?key=AIzaSyCy5yDD4sv5MpITNGhTgXLH5xF3bppXYoM&center=" + 1 + "," + 1 + "&zoom=18&maptype=satellite";

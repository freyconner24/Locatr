var Locatn = React.createClass({displayName: "Locatn",
    render: function() {
        ...
        google.maps.event.addDomListener(window, 'load', function() {initialize(latitude, longitude)}); // Execute our 'initialize' function once the page has loaded. 
            ...
            React.createElement("div", {className: "locatnInfo"}, 
                React.createElement("div", {className: "row mapPicCont"}, 
                    ...
                    React.createElement("div", {className: "col-sm-5 mapCont"}, 
                        React.createElement("div", {className: "map", id: "mapCanvas"}, React.createElement("iframe", {width: "100%", height: "100%", frameBorder: "0", style: {border:0}, src: googleMapsURL, allowFullScreen: true})), 

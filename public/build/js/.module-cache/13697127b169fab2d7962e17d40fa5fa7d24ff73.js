var Projects = React.createClass({displayName: "Projects",
	observe: function() {
        return {
            projects: (new Parse.Query('Locatn')
    ...
    render: function() {
		return (
			React.createElement("div", {className: "sectionCont row"}, 
				...
				React.createElement("div", {onClick: this.showLocatn.bind(this, project.id), key: project.id}, React.createElement(ProjectRow, {project: project}))
			)
		);
	},
